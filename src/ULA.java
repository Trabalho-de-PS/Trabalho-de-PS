...
public class ULA {
	...
	public void ldb(String r1) {
		B.setRegistrador(Integer.parseInt(r1));
	}
	...
	public void ldl(String r1) {
		L.setRegistrador(Integer.parseInt(r1));
	}

	public void lds(String r1) {
		S.setRegistrador(Integer.parseInt(r1));
	}
	...
	public void ldx(String r1) {
		X.setRegistrador(Integer.parseInt(r1));
	}
